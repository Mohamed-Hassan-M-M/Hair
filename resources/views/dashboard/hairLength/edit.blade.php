                                    ...
                                    <div class="card-body">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('hair_length_name') is-invalid @enderror " value="{{old('hair_length_name',$hairLength->hair_length_name)}}" id="hair_length_name" placeholder="Enter hair length name" name="hair_length_name">
